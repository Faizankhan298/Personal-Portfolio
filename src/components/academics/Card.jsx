...
const Card = ({ title, subTitle, result, des }) => {
  return (
    <div className="w-full h-1/4 group flex">
      ...
      <div className="w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg p-8 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadowOne">
